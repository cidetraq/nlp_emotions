The current challenge is to build an emotion classifier. The latest file is 'Keras LSTM.ipynb' Accuracy for that classifier is no greater than 50% on validation data.
